...
PROJECT_DIR="$(pwd)"
CONFIG_PATH="$PROJECT_DIR/test/config"


TRAIN_DATA="/ossfs/workspace/hy65/dzl/data/tool_data/searchr1/data/searchR1_processed_direct/train_part.parquet"
VAL_DATA="/ossfs/workspace/hy65/dzl/data/tool_data/searchr1/data/searchR1_processed_direct/train_part.parquet"

TOOL_CONFIG="$CONFIG_PATH/tool_config/search_tool_config.yaml"
EXPERIMENT_NAME='qwen2.5-3b-instruct_function_part_test' 
# mkdir -p logs
