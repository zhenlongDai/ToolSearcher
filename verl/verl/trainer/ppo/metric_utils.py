...
def compute_data_metrics(batch: DataProto, use_critic: bool = True) -> dict[str, Any]:
    ...
    if "selection_from_search_ratios" in batch.non_tensor_batch:
        selection_from_search_ratios = batch.non_tensor_batch["selection_from_search_ratios"]
        metrics["selection_from_search_ratios/min"] = selection_from_search_ratios.min()
        metrics["selection_from_search_ratios/max"] = selection_from_search_ratios.max()
        metrics["selection_from_search_ratios/mean"] = selection_from_search_ratios.mean()
